...
def parse_opt(known=False):
    ...
    train_path = "train: "+"../../input/text_detection_recreate/images/train/ "
    val_path = "val: "+"../../input/text_detection_recreate/images/val/ "
    test_path = "test: "+"../../input/text_detection_recreate/images/test/ "
