...
parser.add_argument('--reg_coef', action='store', dest='reg_coef', default=10., required=True,
                    help="""regularization coefficient (hyperparameter)""")
parser.add_argument('--gravity_coef_1', action='store', dest='gravity_coef_1', default=10., required=True,
                    help="""gravity coefficient (hyperparameter)""")
...
model = build_regularized_model(train_whole, test_whole,
                                ratings, regularization_coeff=reg_coef_1, gravity_coeff=gravity_coef_1,
                                embedding_dim=embed_dim_1,
